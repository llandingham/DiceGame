...
//if either player gets to 25 then they win
const winCondition = 25;

//selecting the DOM element that will update p1/p22 info
const player0El = document.querySelector(".player--0");
const player1El = document.querySelector(".player--1");

//ternery will conrtoll the playerturn
let activePlayer = 0;

let playing, roll, scores;

//this function mainly changes the CSS and a little bit of
function resetValues() {
  ...
  activePlayer = 0;
  playing = true;
  roll = Math.ceil(Math.random(1) * 6);
}
